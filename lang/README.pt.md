...
| 📊 | **No Telemetry** | Sem rastreamento, sem análises, sem coleta de dados |
...
| **Criptografia** | Argon2 + Node.js Crypto | Client-side encryption robusto |
...
- **LAN File Transfer**: Envie arquivos via LAN — Remetente seleciona arquivos e exibe código de 6 dígitos, Receptor digita o código para encontrar remetente e receber arquivos automaticamente
- **LAN Server Sharing**: Compartilhe configurações de servidor — Remetente seleciona servidores e envia para dispositivo escolhido, Receptor digita código para descriptografar e importar
...
Todos os backups usam **Argon2id** e **AES-256-GCM**:
...
> ℹ️ **Versão pré-construída**: Se você estiver usando a versão pré-construída (AppImage, RPM, etc.), as credenciais do Google já estão incluídas. Você pode pular as etapas 1-3 e conectar diretamente na etapa 4.
