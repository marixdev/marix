...
> **あなた自身のデータに責任があります。**
>
> Marixは強力な暗号化でデバイスにすべてのデータをローカルに保存します。ただし：
> - バックアップパスワードを紛失した場合、**データを復旧できません**
> - **サーバーがありません** — 「パスワードを忘れた」オプションなし
> - **定期的にバックアップしてください** — ハードウェアは故障する可能性があります
> - **セキュリティはあなたのものです** — ツールを提供し、決定はあなたが行います
...
| **暗号化** | Argon2 + Node.js Crypto | 軍事グレードのセキュリティ |
...
すべてのバックアップは**Argon2id**と**AES-256-GCM**軍事グレードの暗号化を使用：
